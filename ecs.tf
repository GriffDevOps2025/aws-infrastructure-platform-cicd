...
# Serverless container orchestration for our web application

# ECS Cluster - Container orchestration control plane
resource "aws_ecs_cluster" "main" {
  name = var.ecs_cluster_name != "" ? var.ecs_cluster_name : "${var.project_name}-cluster"
